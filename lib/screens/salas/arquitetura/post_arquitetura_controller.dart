...
import '../../../models/arquitetura_model/post_arquitetura_model.dart';

class PostArquiteturaController extends GetxController {
  static final postController = Get.put(PostArquiteturaController());
  final scrollPost = ScrollController();
  final title = TextEditingController();
  final content = TextEditingController();
  final postGastr = PostArquiteturaImp();
  ...
  final RxList<IPostModel> _posts = RxList<PostArquiteturaModel>();
  ...
  //############## PUBLICAR NOVO POST
  Future<void> addPost({String category = "architecture"}) async {
    isPost = true;
    update();
...
class PostArquiteturaImp implements IPostRepository {
  @override
  ...
  @override
  Future<List<IPostModel>> newListPost(
      {int limitPost = 10, String category = "architecture"}) async {
    final queryPost = QueryBuilder(ParseObject("Post"))
      ..includeObject(["user"])
      ..orderByDescending("createdAt")
