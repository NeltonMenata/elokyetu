                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _controller.posts[index]["user"]["nome"],
                                      style: TextStyle(
                                        color: Colors.black,
                                    ...
                                    Text(
                                      "${_controller.posts[index]["createdAt"].hour + 1} : ${_controller.posts[index]["createdAt"].minute} |  "
                                      "${_controller.posts[index]["createdAt"].day}/${_controller.posts[index]["createdAt"].month}/${_controller.posts[index]["createdAt"].year}",
                                      style: TextStyle(
                                        color: Colors.black,
                                      ),
                                    )
                      ...
                      ListTile(
                          title: Text(
                            _controller.posts[index]["title"].toString(),
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 16,
                            ),
                          ...
                          subtitle: Text(
                              _controller.posts[index]["content"].toString())),
                      SizedBox(
                        height: 10,
                      ),
                      Center(
                        child: _controller.posts[index]["typeFile"] == 1
                            ? const SizedBox()
                            : Container(
