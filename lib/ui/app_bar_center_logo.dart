              ...
              icon: leftButtonAsset != null
                  ? leftButtonAsset!.endsWith(".svg")
                      ? SvgPicture.asset("assets/svg/$leftButtonAsset",
                          width: iconWidth,
                          height: iconHeight,
                          color: leftIconColor ?? kTransparentColor)
                      : Image.asset(
                          "assets/image/$leftButtonAsset",
                          width: iconWidth,
                          height: iconHeight,
                        )
                  : Icon(leftButtonIcon, color: leftIconColor ?? titleColor),
        ...
        actions: [
          ...
          IconButton(
            icon: rightButtonAsset != null
                ...
                : Icon(rightButtonIcon, color: rightIconColor ?? titleColor),
